        ...
        <div className={`d-print-none ${s.root}`}>
          ...
          <Nav className="ml-md-0">
            ...
            >
              ...
              <Dropdown nav caret style={{ color: "#C1C3CF", padding: 0 }}>
                <span
                  className={`${s.avatar} rounded-circle thumb-sm float-left`}
                >
                  <img src={avatar} alt="..." />
                </span>
                <span className={`small d-sm-down-none ${s.accountCheck}`}>Mughees Asif </span>
            ...
            >
              ...
              <DropdownMenu right className={`${s.dropdownMenu} ${s.support}`}>
                <DropdownItem>
                  ...
                  <div className={s.details}>Product Release</div>
                </DropdownItem>
                <DropdownItem>
                  <Badge color="warning">
                    <i className="fa fa-question-circle" />
                  </Badge>
                  <div className={s.details}>Tasting</div>
                </DropdownItem>
                <DropdownItem>
                  <Badge color="success">
                ...
                <DropdownItem>
                  ...
                  <div className={s.details}>12 new orders have arrived today</div>
                </DropdownItem>
                <DropdownItem>
                  <Badge color="danger">
